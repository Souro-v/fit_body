// lib/screens/meal_plans_screen.dart
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          // ── Background image ───────────────────────────────────────
          AppBgImage(assetPath: 'assets/images/meal_plan_banner.png'),
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          AppIconImage(
                            assetPath: 'assets/icons/ic_nutrition.png',
                            size: 28,
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    onTap: () => Navigator.pushNamed(
                        context, AppRoutes.mealPlanPreferences),
                    child: Container(
                      height: 50,
                      decoration: BoxDecoration(
                      ...
                      child: const Text('Know Your Plan',
                          style: TextStyle(
                              color: Colors.white,
                              fontSize: 16,
