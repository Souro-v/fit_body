...
class OnboardingPageModel {
  ...
  final String iconPath;  // yellow illustration icon (empty = no icon card)
...
const List<OnboardingPageModel> kOnboardingPages = [
  ...
  OnboardingPageModel(
    bgImage: 'assets/images/splash_bg.jpg',
  ...
  OnboardingPageModel(
    bgImage: 'assets/images/onboard1_bg.jpg',
  ...
  // 2-C  Nutrition
  OnboardingPageModel(
    bgImage: 'assets/images/onboard2_bg.jpg',
  ...
  // 2-D  Community
  OnboardingPageModel(
    bgImage: 'assets/images/onboard3_bg.jpg',
